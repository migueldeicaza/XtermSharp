...
namespace XtermSharp {
	...
	class InputHandler {
		...
		public InputHandler (Terminal terminal)
		{
			...
			parser.SetCsiHandler ('A', (pars, collect) => terminalCommands.CursorUp (pars));
			parser.SetCsiHandler ('B', (pars, collect) => terminalCommands.CursorDown (pars));
			parser.SetCsiHandler ('C', (pars, collect) => terminalCommands.CursorForward (pars));
			parser.SetCsiHandler ('D', (pars, collect) => terminalCommands.CursorBackward (pars));
			...
			parser.SetCsiHandler ('c', (pars, collect) => terminalCommands.SendDeviceAttributes (pars, collect));
			...
			parser.SetCsiHandler ('v', (pars, collect) => terminalCommands.CsiCopyRectangularArea (pars, collect));
